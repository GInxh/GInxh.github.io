...
After a healthy understanding of computing constraints on large scale data centers, I moved on to become a DevOps Engineer, specifically an infrastructure architect implementing kubernetes clusters, & as an SRE using [ELK](https://www.elastic.co/products/elasticsearch) stack in house. I took multiple kubernetes security trainings, & focused alot on kubernetes security models & lower level monitoring tools for kubernetes nodes.
